...
{
public : 
	InvalidChoiceException(string m) : Exception(m)
	{}
...
int main()
{
	...
	cin >> name;
	AutoPtr smartPtr(new BookStore(name));
	do
	{
		...
		try
		{
			...
			{
				throw new InvalidChoiceException("Please input valid choice, ");
			}
			else
			{ 
				...
				case 1:
					...
					cin >> bookname;
					smartPtr.getPtr()->AddBook(bookname, bookChoice);
					break;
				case 2:
					cout << "1 : technical 2 : management 3 : both" << endl;
					cin >> bookChoice;
					smartPtr.getPtr()->DisplayBook(bookChoice);
					break;
				case 3:
					cout << " 1 : Technical 2 : Management" << endl;
					cin >> bookChoice;
					if (bookChoice == 1)
					{
						if (smartPtr.getPtr()->countReturn() == 0 || smartPtr.getPtr()->manageCountReturn() == 0)
						{
					...
					{
						if (smartPtr.getPtr()->countReturn() == 0 || smartPtr.getPtr()->techCountReturn() == 0)
						{
							cout << "No books added" << endl;
							break;
						}
					...
					cin >> bookname;
					smartPtr.getPtr()->SearchBook(bookname, bookChoice);
					break;
